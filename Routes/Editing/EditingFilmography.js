...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/editing/filmography");
const dataFile = path.join(process.cwd(), "data/editing/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/editing/filmography/${req.file.filename}`,
    };
