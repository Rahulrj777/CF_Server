...
// 📁 Paths
const UPLOADS_DIR = path.join(process.cwd(), "uploads/editing/banner"); 
...
// ✅ Ensure data/editing folder exists
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const bannerData = {
    ...
    url: `http://localhost:5000/uploads/editing/banner/${req.file.filename}`,
  };
