...
const MENTOR_DIR = path.join(process.cwd(), "uploads/cinematography/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/cinematography");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/cinematography/mentor/${req.file.filename}`,
  };
