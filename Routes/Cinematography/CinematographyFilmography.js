...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/cinematography/filmography");
const dataFile = path.join(process.cwd(), "data/cinematography/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/cinematography/filmography/${req.file.filename}`,
    };
