...
// 📁 Paths
const UPLOADS_DIR = path.join(process.cwd(), "uploads/cinematography/banner"); 
...
// ✅ Ensure data/cinematography folder exists
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const bannerData = {
    ...
    url: `http://localhost:5000/uploads/cinematography/banner/${req.file.filename}`,
  };
