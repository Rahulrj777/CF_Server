...
const MENTOR_DIR = path.join(process.cwd(), "uploads/cfa/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/cfa");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/cfa/mentor/${req.file.filename}`,
  };
