...
const MENTOR_DIR = path.join(process.cwd(), "uploads/vfx/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/vfx");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/vfx/mentor/${req.file.filename}`,
  };
