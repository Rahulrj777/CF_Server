...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/vfx/filmography");
const dataFile = path.join(process.cwd(), "data/vfx/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/vfx/filmography/${req.file.filename}`,
    };
