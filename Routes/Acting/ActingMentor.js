...
const MENTOR_DIR = path.join(process.cwd(), "uploads/acting/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/acting");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/acting/mentor/${req.file.filename}`,
  };
