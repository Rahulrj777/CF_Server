...
// 📁 Paths
const UPLOADS_DIR = path.join(process.cwd(), "uploads/photography/banner"); 
const DATA_DIR = path.join(process.cwd(), "data/photography");
...
// ✅ Ensure data/photography folder exists
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const bannerData = {
    ...
    url: `http://localhost:5000/uploads/photography/banner/${req.file.filename}`,
  };
