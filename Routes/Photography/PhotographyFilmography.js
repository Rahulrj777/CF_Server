...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/photography/filmography");
const dataFile = path.join(process.cwd(), "data/photography/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/photography/filmography/${req.file.filename}`,
    };
