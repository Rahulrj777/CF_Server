...
const MENTOR_DIR = path.join(process.cwd(), "uploads/photography/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/photography");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/photography/mentor/${req.file.filename}`,
  };
