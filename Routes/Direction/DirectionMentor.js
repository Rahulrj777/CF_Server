...
const MENTOR_DIR = path.join(process.cwd(), "uploads/direction/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/direction");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/direction/mentor/${req.file.filename}`,
  };
