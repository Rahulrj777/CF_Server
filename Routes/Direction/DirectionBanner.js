...
// 📁 Paths
const UPLOADS_DIR = path.join(process.cwd(), "uploads/direction/banner"); 
...
// ✅ Ensure data/direction folder exists
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const bannerData = {
    ...
    url: `http://localhost:5000/uploads/direction/banner/${req.file.filename}`,
  };
