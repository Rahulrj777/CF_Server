...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/direction/filmography");
const dataFile = path.join(process.cwd(), "data/direction/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/direction/filmography/${req.file.filename}`,
    };
