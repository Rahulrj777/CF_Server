...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/di/filmography");
const dataFile = path.join(process.cwd(), "data/di/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/di/filmography/${req.file.filename}`,
    };
