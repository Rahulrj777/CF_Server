...
const MENTOR_DIR = path.join(process.cwd(), "uploads/di/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/di");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/di/mentor/${req.file.filename}`,
  };
