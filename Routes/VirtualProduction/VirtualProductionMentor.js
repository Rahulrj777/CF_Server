...
const MENTOR_DIR = path.join(process.cwd(), "uploads/virtualproduction/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/virtualproduction");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/virtualproduction/mentor/${req.file.filename}`,
  };
