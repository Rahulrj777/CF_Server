...
// 📁 Paths
const UPLOADS_DIR = path.join(process.cwd(), "uploads/virtualproduction/banner"); 
...
// ✅ Ensure data/virtualproduction folder exists
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const bannerData = {
    ...
    url: `http://localhost:5000/uploads/virtualproduction/banner/${req.file.filename}`,
  };
