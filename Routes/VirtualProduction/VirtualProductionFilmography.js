...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/virtualproduction/filmography");
const dataFile = path.join(process.cwd(), "data/virtualproduction/filmography.json");
...
// Get all virtualproduction items
router.get("/", (req, res) => {
  try {
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/virtualproduction/filmography/${req.file.filename}`,
    };
