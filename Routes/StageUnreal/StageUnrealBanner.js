...
// 📁 Paths
const UPLOADS_DIR = path.join(process.cwd(), "uploads/stageunreal/banner"); 
const DATA_DIR = path.join(process.cwd(), "data/stageunreal");
...
// ✅ Ensure data/stageunreal folder exists
...
router.post("/upload", upload.single("video"), (req, res) => {
  ...
  const bannerData = {
    ...
    url: `http://localhost:5000/uploads/stageunreal/banner/${req.file.filename}`,
  };
