...
const MENTOR_DIR = path.join(process.cwd(), "uploads/stageunreal/mentor"); // images
const DATA_DIR = path.join(process.cwd(), "data/stageunreal");               // JSON folder
...
router.post("/upload", upload.single("image"), (req, res) => {
  ...
  const mentorData = {
    ...
    url: `http://localhost:5000/uploads/stageunreal/mentor/${req.file.filename}`,
  };
