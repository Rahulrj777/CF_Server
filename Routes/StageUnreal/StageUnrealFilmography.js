...
// Folder paths
const uploadDir = path.join(process.cwd(), "uploads/stageunreal/filmography");
const dataFile = path.join(process.cwd(), "data/stageunreal/filmography.json");
...
router.post("/upload", upload.single("image"), (req, res) => {
  try {
    ...
    const newItem = {
      id: Date.now(),
      image: `/uploads/stageunreal/filmography/${req.file.filename}`,
    };
